...
public class UserOfComparability {
	...
	Date d0 = new Date(2002,12,30);
	Date d1 = new Date(2004,10,15);

	reportRelationship( "Same date vs same date", d0
                          , d0, "0");
	reportRelationship( "date vs. later date", d0
                          , d1, "-1");
	reportRelationship( "later date vs date", d1
                          , d0, "1");

	// Failures
	/*
	reportRelationship( "point to date", p0
                          , d0, "error");
        
	IncomparableDog a = new IncomparableDog();
	
	reportRelationship( "point to date", a
			    , a, "error");
	*/
    }
